...
function ligar(){
    document.getElementById('lampada').src = "https://www.w3schools.com/html/pic_bulbon.gif"
}
function desligar(){
    document.getElementById('lampada').src = "https://www.w3schools.com/html/pic_bulboff.gif"
}
